...
const Landing = ({player1Name, setPlayer1Name, player2Name, setPlayer2Name, handlePlayerNamesSubmit }) => {
  ...
  const handlePlayerNamesValidateSubmit = () => {
    if (gameMode === ""){
  ...
  return (
    <div className="container">
      ...
      <div className="gameMode">
        ...
        <button class="btn btn-outline-success" onClick={handlePlayerNamesValidateSubmit}>Play</button>
      </div>
    </div>
  );
};
